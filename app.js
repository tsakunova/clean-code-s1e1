...
var createNewTaskElement=function(taskString){
    ...
    label.className="todo-item__label input-style";

    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.classList="todo-item__checkbox";
    editInput.type="text";
    editInput.className="todo-item__input-text input-style";

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.className="todo-item__btn edit";

    deleteButton.className="todo-item__btn delete";
...
var editTask=function(){
    ...
    var editInput=listItem.querySelector('.todo-item__input-text');
